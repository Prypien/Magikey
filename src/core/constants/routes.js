...
export const ROUTE_NAMES = freeze({
  ...
  ADMIN_COMPANY_DETAIL: 'admin-company-detail',
...
export const ROUTE_PATHS = freeze({
  ...
  [ROUTE_NAMES.ADMIN_COMPANY_DETAIL]: '/admin/companies/:companyId',
...
export const ROUTE_LOCATIONS = freeze({
  ...
  ADMIN_COMPANY_DETAIL: createLocation(ROUTE_NAMES.ADMIN_COMPANY_DETAIL),
