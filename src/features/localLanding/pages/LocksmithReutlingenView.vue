...
const schemaOrg = {
  ...
  url: 'https://www.magikey.de/schluesseldienst/reutlingen',
}
...
useHead({
  ...
  link: [
    { rel: 'canonical', href: 'https://www.magikey.de/schluesseldienst/reutlingen' },
  ],
  script: [
    {
      type: 'application/ld+json',
      children: JSON.stringify(schemaOrg, null, 2),
    },
  ],
})
</script>
